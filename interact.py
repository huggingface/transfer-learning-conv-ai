...
def run():
    ...
    parser.add_argument("--dataset_cache", type=str, default='./dataset_cache.bin', help="Path or url of the dataset cache")
    parser.add_argument("--model", type=str, default="", help="Path, url or short name of the model")
